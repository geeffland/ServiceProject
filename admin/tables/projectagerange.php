 ...
 * @subpackage	admin.tables
 */
class ServiceProjectTableProjectAgeRange extends JTable
{
	protected $tabletype 	= 'ProjectAgeRange';
	...
	{
		parent::__construct('#__serviceproject_project_ageranges', 'id', $_db);
