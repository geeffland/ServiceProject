 ...
 *
 */
class ServiceProjectControllerEventGroups extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = array())
	{
		...
		$this->text_prefix="COM_SERVICEPROJECT_EVENTGROUPS";
	 ...
	 * @since	1.6
	 */
	public function &getModel($name = 'EventGroup', $prefix = 'ServiceProjectModel')
	{
