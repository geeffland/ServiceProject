 ...
 *
 */
class ServiceProjectControllerConfigurations extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = array())
	{
		...
		$this->text_prefix="COM_SERVICEPROJECT_CONFIG";
	 ...
	 * @since	1.6
	 */
	public function &getModel($name = 'Config', $prefix = 'ServiceProjectModel')
	{
