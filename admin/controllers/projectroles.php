 ...
 *
 */
class ServiceProjectControllerProjectRoles extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = array())
	{
		...
		$this->text_prefix="COM_SERVICEPROJECT_PROJECTROLES";
	 ...
	 * @since	1.6
	 */
	public function &getModel($name = 'ProjectRole', $prefix = 'ServiceProjectModel')
	{
