<?php
/**
 * This controller is called for by Linked Profiles tasks
 *
 * @version		$Id: linkedprofiles.php
 ...
 *
 */
class ServiceProjectControllerLinkedProfiles extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = array())
	{
		...
		$this->text_prefix="COM_SERVICEPROJECT_LINKED_PROFILES";
...
//		$this->registerTask('merge',	'merge');
	 ...
	 * @since	1.6
	 */
	public function &getModel($name = 'LinkedProfile', $prefix = 'ServiceProjectModel')
	{
