 ...
 *
 */
class ServiceProjectControllerProjectSkills extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = array())
	{
		...
		$this->text_prefix="COM_SERVICEPROJECT_PROJECT_SKILLS";
	 ...
	 * @since	1.6
	 */
	public function &getModel($name = 'ProjectSkill', $prefix = 'ServiceProjectModel')
	{
