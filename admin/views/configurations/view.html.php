 ...
 */
class ServiceProjectViewConfigurations extends JView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVICEPROJECT_MANAGE_CONFIGURATIONS'), 'article.png');
		if ($canDo->get('core.create')) {
			JToolBarHelper::custom('configuration.add', 'new.png', 'new_f2.png','JTOOLBAR_NEW', false);
		}
		if ($canDo->get('core.edit')) {
			JToolBarHelper::custom('configuration.edit', 'edit.png', 'edit_f2.png','JTOOLBAR_EDIT', true);
		}
