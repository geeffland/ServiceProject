...
<script type="text/javascript">
	...
	{
		if (task == 'projectagerange.cancel' || document.formvalidator.isValid(document.id('item-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_serviceproject&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	<div class="width-60 fltlft">
		...
		<legend><?php echo empty($this->item->id) ? JText::_('COM_SERVICEPROJECT_NEW_PROJECT_AGERANGE') : JText::sprintf('COM_SERVICEPROJECT_EDIT_PROJECT_AGERANGE', $this->item->id); ?></legend>
