...
<script type="text/javascript">
	...
	{
		if (task == 'projectcategory.cancel' || document.formvalidator.isValid(document.id('item-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_serviceproject&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	<div class="width-60 fltlft">
		...
		<legend><?php echo empty($this->item->id) ? JText::_('COM_SERVICEPROJECT_NEW_PROJECT_CATEGORY') : JText::sprintf('COM_SERVICEPROJECT_EDIT_PROJECT_CATEGORY', $this->item->id); ?></legend>
