 ...
 */
class ServiceProjectViewProfiles extends JView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVICEPROJECT_MANAGE_PROFILES'), 'article.png');
		...
		if ($canDo->get('core.edit')) {
			...
			JToolBarHelper::custom('profiles.copy', 'e1s-copy', '','COM_SERVICEPROJECT_TOOLBAR_COPY', true);
			JToolBarHelper::custom('profiles.merge', 'e1s-merge', '','COM_SERVICEPROJECT_TOOLBAR_MERGE', true);
		}
