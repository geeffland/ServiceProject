...
<html>
  <head>
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/4d953aad9b83e90155d30a7aed3651e68aa4c2fc/stylesheets/bundle_github.css" media="screen" rel="stylesheet" type="text/css" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/5b6cc5fff32b748891be69a8fe9d12db825ddddf/javascripts/bundle_github.js" type="text/javascript"></script>
  ...
  <body class="logged_out page-blob  windows env-production">
    ...
    <ul class="actions">
        ...
        <li>
          <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch " id="watch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'c83de30efa662b52424a5e521009e2c41bc884de'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch " id="unwatch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'c83de30efa662b52424a5e521009e2c41bc884de'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/douglascrockford/JSON-js/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'c83de30efa662b52424a5e521009e2c41bc884de'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/douglascrockford/JSON-js/watchers" title="Watchers" class="tooltipped downwards">614</a></li>
          <li class="forks"><a href="/douglascrockford/JSON-js/network" title="Forks" class="tooltipped downwards">34</a></li>
        </ul>
      </li>
    </ul>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/douglascrockford/JSON-js/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="c83de30efa662b52424a5e521009e2c41bc884de" /></div>
...
<div class="flash-messages"></div>
  ...
  <div class="envelope commit">
    <div class="human">
        ...
        <div class="message"><pre><a href="/douglascrockford/JSON-js/commit/8e0b15cb492f63067a88ad786e4d5fc0fa89a241">!isFinite</a> <a href="/douglascrockford/JSON-js/commit/8e0b15cb492f63067a88ad786e4d5fc0fa89a241#comments"><img alt="Comment" height="16" src="https://a248.e.akamai.net/assets.github.com/images/modules/dashboard/news/comment.png" width="16" /></a></pre></div>
      

      <div class="actor">
        <div class="gravatar">
          
          <img src="https://secure.gravatar.com/avatar/b871de839c31ddb1d9db8e33e0cb88a6?s=140&d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" alt="" width="30" height="30"  />
        </div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="json2.js/">
      <b><a href="/douglascrockford/JSON-js/tree/8e0b15cb492f63067a88ad786e4d5fc0fa89a241">JSON-js</a></b> / json2.js       <span style="display:none" id="clippy_4044">json2.js</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_4044&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_4044&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
  ...
  <img src="https://a248.e.akamai.net/assets.github.com/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.10106s from fe3.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
    ...
    <script>window._auth_token = "c83de30efa662b52424a5e521009e2c41bc884de"</script>
